...
import ru.otus.homework.testtask.sevice.BookService;
...
public class BookCommands {
    ...
    private final BookService dataStorageService;
    private final ShellParametersConverter paramsConverter;
    private final MessageSourceWrapper messageSourceWrapper;

    @Autowired
    public BookCommands(BookService dataStorageService, ShellParametersConverter paramsConverter, MessageSourceWrapper messageSourceWrapper) {
    ...
    public void addBook(@ShellOption String name,
                        ...
                        @ShellOption int pubYear,
                        @ShellOption String authors,
                        @ShellOption String genres) throws Exception {
    ...
    public void updateBook(@ShellOption long bookId,
        ...
        Book book = new Book(null, name, description, pubYear, paramsConverter.authorsString2List(authors), paramsConverter.genresString2List(genres));
        dataStorageService.updateBook(book);
    }
